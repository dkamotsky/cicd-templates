...
from typing import Any, Mapping, Callable, Optional, Iterable, Tuple, MutableMapping, List
...
class AbstractEvaluateAndPromoteStep(ABC):
    ...
    def __call__(self, spark: sql.SparkSession, target_stage: str) -> bool:
        ...
        cand_run_ids: Iterable[str] = self.experiment_data.where("tags.candidate='true'").select("run_id").toPandas()['run_id'].values
